      ...
      try {
        ...
        if (responseData.query) {
          ...
          setMessages([
            ...
            { 
              text: responseData.message || responseData.response || responseData.output || "I've processed your E-commerce question. Check the preview panel for the detailed response.", 
              isUser: false, 
              timestamp: new Date() 
            }
          ]);
