...
const EcommerceExpertPage = () => {
  ...
  const handleN8nResponse = async (query) => {
    ...
    try {
      ...
      const responseText = data.message || data.response || "I've processed your E-commerce question. Check the preview panel for detailed results.";
      ...
      setMessages(prev => [...prev, { 
        text: "I'm having trouble connecting to the E-commerce expert workflow. Please try again later.", 
        isUser: false, 
        timestamp: new Date() 
      }]);
      setIsLoading(false);
