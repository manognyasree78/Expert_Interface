  ...
  const handleN8nResponse = async (query) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const responseText = data.message || data.response || data.output || "I've processed your E-commerce question. Check the preview panel for detailed results.";
        ...
        <div className="hidden md:flex md:w-[70%] bg-gray-50 flex-col">
          ...
          <div className="p-6 bg-white border-b border-gray-200">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold text-gray-900">E-commerce Modernization Preview</h2>
